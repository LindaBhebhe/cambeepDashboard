    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage <b>Stationery</b></h2>
					</div>
					<div class="col-sm-6">

						<a href="#addStationeryModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add</span></a>

						<!-- <a href="#updateStationeryModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE254;</i> <span>Update </span></a -->

						<a href="#deleteStationeryModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>	
            ...
            <!-----------------------------load from a different scrip---------------------------->
            <?php
            include("manageStationery.php");
            ?> 
           
            <!----------------------------------load from different script the code above ------------------>
			...
			<div class="clearfix">
             ...
             <a  href="../interfaces/dashboard.php">Back to dashboard</a>
        </div>
    </div>
			...
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">					
						...
						<p class="text-warning"><small>You cannot undo after deleting</small></p>
					</div>
